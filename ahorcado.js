alert("este juego ha sido iniciado")
var palabras = ["broken", "alura","dango","michael","gato","america","pizza","spiderman","harry","aj","mexico"];
...
function buscar(letra) {
	...
	if(error==7){
		alert("lo siento mucho, intentalo de nuevo");
		}
	console.log(letra);
